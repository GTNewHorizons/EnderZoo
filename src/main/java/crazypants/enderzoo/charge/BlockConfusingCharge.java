...
public class BlockConfusingCharge extends BlockTNT implements ICharge {
    ...
    public void explodeEffect(World world, double x, double y, double z) {
        ...
        List<EntityPlayer> players = world.getEntitiesWithinAABB(
                EntityPlayer.class,
                EntityUtil.getBoundsAround(x, y, z, Config.confusingChargeRange));
        if (players != null) {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            EntitySpellParticleFX entityfx = new EntitySpellParticleFX(
                    world,
                    x + motionX * 0.1,
                    y + motionY * 0.1,
                    z + motionZ * 0.1,
