...
public class EntityAIAttackOnCollideOwned extends EntityAIAttackOnCollide {
    ...
    public EntityAIAttackOnCollideOwned(IOwnable<? extends EntityCreature, ? extends EntityLivingBase> ownable,
            Class<?> p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_, EntityAIFollowOwner followTask) {
    ...
    public EntityAIAttackOnCollideOwned(IOwnable<? extends EntityCreature, ? extends EntityLivingBase> ownable,
            double p_i1636_2_, boolean p_i1636_4_, EntityAIFollowOwner followTask) {
